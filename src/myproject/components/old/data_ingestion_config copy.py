...
INPUT_FEATURE_DATA = (BASE_DIR / os.getenv("INPUT_FEATURE_PATH")).resolve()
TARGET_FEATURE_DATA = (BASE_DIR / os.getenv("TARGET_FEATURE_PATH")).resolve()
X_TRAIN_DATA = (BASE_DIR / os.getenv("X_TRAIN_DATA_PATH")).resolve()
X_VAL_DATA = (BASE_DIR / os.getenv("X_VAL_DATA_PATH")).resolve()
X_TEST_DATA = (BASE_DIR / os.getenv("X_TEST_DATA_PATH")).resolve()
Y_TRAIN_DATA = (BASE_DIR / os.getenv("Y_TRAIN_DATA_PATH")).resolve()
Y_VAL_DATA = (BASE_DIR / os.getenv("Y_VAL_DATA_PATH")).resolve()
Y_TEST_DATA = (BASE_DIR / os.getenv("Y_TEST_DATA_PATH")).resolve()
#--------------------------------------------------------------------
# Ensure necessary directories exist; otherwise, create them
#--------------------------------------------------------------------
ensure_directory_exists(RAW_DATA.parent)
ensure_directory_exists(INPUT_FEATURE_DATA.parent)
ensure_directory_exists(TARGET_FEATURE_DATA.parent)
ensure_directory_exists(X_TRAIN_DATA.parent)
ensure_directory_exists(X_VAL_DATA.parent)
ensure_directory_exists(X_TEST_DATA.parent)
ensure_directory_exists(Y_TRAIN_DATA.parent)
ensure_directory_exists(Y_VAL_DATA.parent)
ensure_directory_exists(Y_TEST_DATA.parent)
#--------------------------------------------------------------------
# Log the data paths
#--------------------------------------------------------------------
